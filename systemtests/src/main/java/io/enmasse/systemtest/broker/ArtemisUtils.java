...
public class ArtemisUtils {
    ...
    public static Map<String, Object> getAddressSettings(Kubernetes kubernetes, AddressSpace addressSpace) throws InterruptedException {
        ...
        ExecutionResultData jmxResponse = KubeCMDClient.runOnPod(kubernetes.getInfraNamespace(), podName, Optional.of("broker"),
                ...
                String.format("https://localhost:8161/console/jolokia/exec/org.apache.activemq.artemis:broker=\"%s\"/getAddressSettingsAsJSON/myqueue", podName));
